...
if __name__ == "__main__":
    ...
    parser.add_argument("--no_simulation", "-n", dest="no_simulation", action="store_false",
                        help="Used to run the program without the simulation.")
    parser.add_argument("--port", "-p", type=str, dest="port",
                        help="Selects the port to control arm if arduino is conected.")
    parser.add_argument("--baudrate", "-b", type=int, dest="baud_rate", default=DEFAULT_BAUDRATE,
                        help="Selects the port to control arm if arduino is conected.")
